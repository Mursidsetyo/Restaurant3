...
<div class="restaurant-item">
  <div class="restaurant-item__header">
      <img class="lazyload" alt="${restaurants.name}"
  ...
  <h3 class="header-name" id="header-name"><a href="${`/#/detail/${restaurants.id}`}">${restaurants.name}</a></h3>
...
const createEmptyText = () => `
    <div id="empty">
        <p id="message" class="empty-favorite">Tidak Ada Restoran Favorit<p>
    </div>
`;
export {
